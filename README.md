...
This means that it is a TLD that is not mostly used now but there is a probability that it will be abused, like the new .zip TLD that Google is offering.
